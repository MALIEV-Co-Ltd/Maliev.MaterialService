...
namespace Maliev.MaterialService.Tests.Integration
{
    ...
    public class BulkOperationsControllerTests : IClassFixture<IntegrationTestWebAppFactory>, IDisposable
    {
        ...
        public async Task BulkImport_WithValidJsonFile_CreatesMaterials()
        {
            ...
            // Act
            var response = await _client.PostAsync("/materials/v1/bulk/import", multipartContent);
        ...
        public async Task BulkImport_WithDryRun_DoesNotSaveData()
        {
            ...
            // Act
            var response = await _client.PostAsync("/materials/v1/bulk/import?dryRun=true", multipartContent);
        ...
        {
            // Act
            var response = await _client.GetAsync("/materials/v1/bulk/export?format=csv");
        ...
        {
            var response = await _client.GetAsync("/materials/v1/materials?pageSize=1");
