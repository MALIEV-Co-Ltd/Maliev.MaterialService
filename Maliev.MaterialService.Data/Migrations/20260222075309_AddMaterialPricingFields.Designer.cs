...
namespace Maliev.MaterialService.Data.Migrations
{
    ...
    [Migration("20260222075309_AddMaterialPricingFields")]
    partial class AddMaterialPricingFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Maliev.MaterialService.Data.Entities.Material", b =>
                {
                    ...
                    b.Property<string>("ProcessParameters")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasColumnName("process_parameters")
            ...
            modelBuilder.Entity("ColorMaterial", b =>
                {
                    b.HasOne("Maliev.MaterialService.Data.Entities.Color", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Maliev.MaterialService.Data.Entities.Material", b =>
                {
                    b.HasOne("Maliev.MaterialService.Data.Entities.Supplier", "Supplier")
                        .WithMany("Materials")
            ...
            modelBuilder.Entity("Maliev.MaterialService.Data.Entities.MaterialMechanicalProperty", b =>
                {
                    ...
                    b.HasOne("Maliev.MaterialService.Data.Entities.MechanicalProperty", "MechanicalProperty")
            ...
            modelBuilder.Entity("ManufacturingProcessMaterial", b =>
                {
                    b.HasOne("Maliev.MaterialService.Data.Entities.ManufacturingProcess", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MaterialPostProcessingMethod", b =>
                {
                    ...
                    b.HasOne("Maliev.MaterialService.Data.Entities.PostProcessingMethod", null)
                        .WithMany()
